...
public class PoolProblem {
	...
	/************************************************************************************
	 * Take in intervals of time and return the maximum time covered after removing
	 * the interval with minimum impact
	 ************************************************************************************/
	...
	public static int FindBestTime(File file) {
		...
		for (int i = 0; i < ListIntervals.size(); i++) {
			...
			if (i == ListIntervals.size() - 1) {
				...
				// If next Intervals are completely covered within current Intervals range e.g.
				// (4,10) (5,7)
		...
		// Go through the list of distinct time shifts covered by each employee and
		// return the calculated max time possible
		int maxtime = 0;
		for (int x : distinct) {
